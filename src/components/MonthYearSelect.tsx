    ...
    <div className="flex items-center justify-between bg-gray-900 rounded-lg p-3 border border-gray-700">
      ...
      <div className="flex gap-4 ">
        ...
        <select
          ...
          id="month-select"
          className="bg-gray-800 border border-gray-700 rounded-md py-1 px3-3 text-sm font-medium text-gray-100 focus: outline-none focus:ring-1 focus: ring-primary-500 cursor-pointer"
        >
